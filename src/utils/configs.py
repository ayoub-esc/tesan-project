...
class Configs(object):
    def __init__(self):
        ...
        # @ ----- control ----
        parser.add_argument('--model', type=str, default='tesan', help='normal_sa, interval, multi_sa or tesan ')
        ...
        parser.add_argument('--task', type=str, default='embedding', help='embedding or prediction')
